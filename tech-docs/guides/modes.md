...
`tech-docs/integration/governance-adapter.md` for request or response examples, the
...
published `tech-docs/` packets, or `@last`.
...
- `architecture` publishes its packet and one standard ADR into `tech-docs/adr/ADR-XXXX-<slug>.md` by default.
...
- `--to` only changes the packet destination; ADR files still land under `tech-docs/adr/`.
...
- `architecture` -> `tech-docs/architecture/decisions/<YYYY-MM-DD>-<descriptor>/`
- `backlog` -> `tech-docs/planning/<YYYY-MM-DD>-<descriptor>/`
- `change` -> `tech-docs/changes/<YYYY-MM-DD>-<descriptor>/`
- `implementation` -> `tech-docs/implementation/<YYYY-MM-DD>-<descriptor>/`
- `incident` -> `tech-docs/incidents/<YYYY-MM-DD>-<descriptor>/`
- `security-assessment` -> `tech-docs/security-assessments/<YYYY-MM-DD>-<descriptor>/`
- `system-assessment` -> `tech-docs/architecture/assessments/<YYYY-MM-DD>-<descriptor>/`
- `migration` -> `tech-docs/migrations/<YYYY-MM-DD>-<descriptor>/`
- `supply-chain-analysis` -> `tech-docs/supply-chain/<YYYY-MM-DD>-<descriptor>/`
- `refactor` -> `tech-docs/refactors/<YYYY-MM-DD>-<descriptor>/`
- `review` -> `tech-docs/reviews/<YYYY-MM-DD>-<descriptor>/`
- `verification` -> `tech-docs/verification/<YYYY-MM-DD>-<descriptor>/`
- `pr-review` -> `tech-docs/reviews/prs/<YYYY-MM-DD>-<descriptor>/`
...
|-------|---------|----------------|
| `auto` | Output is promoted automatically | The mode's canonical stable surface such as `tech-docs/project/product-context.md`, `tech-docs/project/architecture-map.md`, or `tech-docs/project/delivery-map.md` |
| `auto-if-approved` | Promoted only when approval is complete | The same canonical stable surface the mode would use under `auto` |
| `pending-index` | Updates pending or audit surfaces only | A named pending or risk surface such as `tech-docs/project/pending-decisions.md` or `tech-docs/project/open-risks.md` |
| `index-only` | Records in index surfaces without stable mutation | A named audit-style surface such as `tech-docs/project/audit-log.md` |
| `evidence-only` | Updates evidence output only | A named audit or risk surface plus `tech-docs/evidence/<mode>/<RUN_ID>/` support material |
...
- `discovery` -> `tech-docs/project/overview.md`
- `requirements` -> `tech-docs/project/product-context.md`
- `system-shaping`, `architecture` -> `tech-docs/project/architecture-map.md`
- `change`, `migration` -> `tech-docs/project/decision-index.md`
- `backlog`, `implementation`, `refactor` -> `tech-docs/project/delivery-map.md`
- `domain-language` -> `tech-docs/project/domain-language.md`
- `domain-model` -> `tech-docs/project/domain-model.md`
- `review`, `pr-review`, `verification` -> `tech-docs/project/audit-log.md` plus `tech-docs/evidence/<mode>/<RUN_ID>/`
- `incident`, `security-assessment`, `supply-chain-analysis`, `system-assessment` -> `tech-docs/project/open-risks.md` plus `tech-docs/evidence/<mode>/<RUN_ID>/`
...
- publish the approved discovery packet with `canon publish <RUN_ID>` to `tech-docs/discovery/<YYYY-MM-DD>-<descriptor>/`, or use `--to` for a different public destination
...
See [tech-docs/examples/canon-input/discovery-legacy-migration.md](tech-docs/examples/canon-input/discovery-legacy-migration.md)
...
Instead of generic templates, Canon uses realistic bounded documents.
See [tech-docs/examples/canon-input/requirements-api-v2.md](tech-docs/examples/canon-input/requirements-api-v2.md)
...
- publish the approved system-shaping packet with `canon publish <RUN_ID>` to `tech-docs/architecture/shaping/<YYYY-MM-DD>-<descriptor>/`, or use `--to` for another public destination
...
Instead of generic templates, Canon uses realistic bounded documents.
See [tech-docs/examples/canon-input/system-shaping-billing.md](tech-docs/examples/canon-input/system-shaping-billing.md)
...
- publish the approved architecture packet with `canon publish <RUN_ID>` to `tech-docs/architecture/decisions/<YYYY-MM-DD>-<descriptor>/`, where `architecture-overview.md` is the main review entrypoint and the sidecar views plus manifests remain available for deeper inspection, or use `--to` for another public destination
...
Instead of generic templates, Canon uses realistic bounded documents.
See [tech-docs/examples/canon-input/architecture-state-management.md](tech-docs/examples/canon-input/architecture-state-management.md)
...
Instead of generic templates, Canon uses realistic bounded documents.
Start from [defaults/templates/canon-input/backlog.md](defaults/templates/canon-input/backlog.md)
for the canonical brief structure, then see
[tech-docs/examples/canon-input/backlog-auth-session-hardening.md](tech-docs/examples/canon-input/backlog-auth-session-hardening.md)
...
- publish the approved change packet with `canon publish <RUN_ID>` to `tech-docs/changes/<YYYY-MM-DD>-<descriptor>/`, or use `--to` for another public destination
...
Instead of generic templates, Canon uses realistic bounded documents.
See [tech-docs/examples/canon-input/change-add-caching.md](tech-docs/examples/canon-input/change-add-caching.md)
...
- publish the approved implementation packet with `canon publish <RUN_ID>` to `tech-docs/implementation/<YYYY-MM-DD>-<descriptor>/`, or use `--to` for another public destination
...
See [`defaults/templates/canon-input/implementation.md`](defaults/templates/canon-input/implementation.md)
for the starter template, [`tech-docs/examples/canon-input/implementation-auth-session-revocation.md`](tech-docs/examples/canon-input/implementation-auth-session-revocation.md)
for a populated single-file example, and
[`tech-docs/examples/canon-input/carry-forward-packets.md`](tech-docs/examples/canon-input/carry-forward-packets.md)
...
[`tech-docs/guides/skill-runtime-contracts.md`](skill-runtime-contracts.md) for
details.
...
- publish the approved refactor packet with `canon publish <RUN_ID>` to `tech-docs/refactors/<YYYY-MM-DD>-<descriptor>/`, or use `--to` for another public destination
- inspect the emitted packet before accepting or expanding any later mutation posture
- move to `review` when a non-PR packet needs explicit disposition
- move to `pr-review` when the real target becomes a diff or `WORKTREE`
...
See [`defaults/templates/canon-input/refactor.md`](defaults/templates/canon-input/refactor.md)
for the starter template, [`tech-docs/examples/canon-input/refactor-auth-session-cleanup.md`](tech-docs/examples/canon-input/refactor-auth-session-cleanup.md)
for a populated single-file example, and
[`tech-docs/examples/canon-input/carry-forward-packets.md`](tech-docs/examples/canon-input/carry-forward-packets.md)
for the folder-backed carry-forward packet pattern.
...
- publish the approved review packet with `canon publish <RUN_ID>` to `tech-docs/reviews/<YYYY-MM-DD>-<descriptor>/`, or use `--to` for another public destination
...
Instead of generic templates, Canon uses realistic bounded documents.
See [tech-docs/examples/canon-input/review-db-migration.md](tech-docs/examples/canon-input/review-db-migration.md)
...
- publish the approved verification packet with `canon publish <RUN_ID>` to `tech-docs/verification/<YYYY-MM-DD>-<descriptor>/`, or use `--to` for another public destination
...
Instead of generic templates, Canon uses realistic bounded documents.
See [tech-docs/examples/canon-input/verification-e2e-flakiness.md](tech-docs/examples/canon-input/verification-e2e-flakiness.md)
...
- publish the approved PR review packet with `canon publish <RUN_ID>` to `tech-docs/reviews/prs/<YYYY-MM-DD>-<descriptor>/`, or use `--to` for another public destination
...
- publish readable packets to `tech-docs/incidents/<YYYY-MM-DD>-<descriptor>/` for external review, even when the run is still approval-gated or blocked
...
- publish readable packets to `tech-docs/architecture/assessments/<YYYY-MM-DD>-<descriptor>/` for broader review, even when the run is still blocked or approval-gated
...
See [defaults/templates/canon-input/system-assessment.md](defaults/templates/canon-input/system-assessment.md)
for the starter template and
[tech-docs/examples/canon-input/system-assessment-commerce-platform.md](tech-docs/examples/canon-input/system-assessment-commerce-platform.md)
...
- publish readable packets to `tech-docs/migrations/<YYYY-MM-DD>-<descriptor>/` for external review, even when the run is still approval-gated or blocked
...
See [defaults/templates/canon-input/migration.md](defaults/templates/canon-input/migration.md)
for the starter template and
[tech-docs/examples/canon-input/migration-platform-consolidation.md](tech-docs/examples/canon-input/migration-platform-consolidation.md)
for a populated single-file example.
...
- approve `gate:risk` when a systemic or red-zone packet is credible enough for governed review
- publish readable packets to `tech-docs/supply-chain/<YYYY-MM-DD>-<descriptor>/` for broader review, even when the run is still blocked or approval-gated
- move to `change`, `migration`, or `security-assessment` when the next real step is modernization, replacement, or threat review

### Example Input

See [defaults/templates/canon-input/supply-chain-analysis.md](defaults/templates/canon-input/supply-chain-analysis.md)
for the starter template and
[tech-docs/examples/canon-input/supply-chain-analysis-rust-workspace.md](tech-docs/examples/canon-input/supply-chain-analysis-rust-workspace.md)
for a populated single-file example.
...
- approve `gate:risk` when a systemic or red-zone packet is credible enough for governed review
- publish readable packets to `tech-docs/domain/language/<YYYY-MM-DD>-<descriptor>/` for broader review
...
See [defaults/templates/canon-input/domain-language.md](defaults/templates/canon-input/domain-language.md)
for the starter template and
[tech-docs/examples/canon-input/domain-language-order-fulfillment.md](tech-docs/examples/canon-input/domain-language-order-fulfillment.md)
for a populated single-file example.
...
- approve `gate:risk` when a systemic or red-zone packet is credible enough for governed review
- publish readable packets to `tech-docs/domain/model/<YYYY-MM-DD>-<descriptor>/` for broader review
...
See [defaults/templates/canon-input/domain-model.md](defaults/templates/canon-input/domain-model.md)
for the starter template and
[tech-docs/examples/canon-input/domain-model-order-fulfillment.md](tech-docs/examples/canon-input/domain-model-order-fulfillment.md)
for a populated single-file example.
