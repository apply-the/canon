...
For machine-facing integration, use the canonical source guide: [Governance Adapter Integration](https://github.com/apply-the/canon/blob/main/docs/integration/governance-adapter.md).
