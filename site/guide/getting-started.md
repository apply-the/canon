...
The canonical command walkthrough lives in the source repo: [Getting Started with Canon](https://github.com/apply-the/canon/blob/main/docs/guides/getting-started.md).
...
For the complete mode guide, use [[Canon Modes|Canon-Modes]] and the source guide: [Canon Mode Guide](https://github.com/apply-the/canon/blob/main/docs/guides/modes.md).
