...
This page explains what needs to exist before Canon can produce governed packets in a repository.
...
- source builds for development

Canonical source: [Canon README](https://github.com/apply-the/canon/blob/main/README.md).
...
- published packet destinations under visible repository paths such as `docs/` or `specs/`
...
- [Assistant plugin packages](https://github.com/apply-the/canon/blob/main/docs/guides/assistant-plugin-packages.md)
- [Skill runtime contracts](https://github.com/apply-the/canon/blob/main/docs/guides/skill-runtime-contracts.md)
...
If a downstream orchestrator is involved, confirm whether it should use the human CLI surface or the machine-facing governance adapter. See [[Boundline Integration|Boundline-Integration]].
