...
| `README.md`, `ROADMAP.md`, and `tech-docs/guides/modes.md` | impacted guidance describes the delivered reasoning-evidence contract without overstating runtime behavior | focused docs review and release-surface checks pass |
