...
- [X] T026 [P] Update operator-facing docs, site, and roadmap content in README.md, tech-docs/guides/getting-started.md, site/guide/getting-started.md, site/roadmap/index.md, and ROADMAP.md
