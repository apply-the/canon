...
- [X] T026 [P] Update operator-facing docs, docs, and roadmap content in README.md, tech-docs/guides/getting-started.md, docs/guide/getting-started.md, docs/roadmap/index.md, and ROADMAP.md
