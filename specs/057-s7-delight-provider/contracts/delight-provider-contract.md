...
- `schema_version`: `v1`
- `stable_doc`: `docs/integration/delight-provider-contract.md`
...
- **Source anchors**:
  ...
  - packet metadata sidecars described in `docs/integration/governance-adapter.md`
  - promoted managed surfaces governed by `docs/integration/project-memory-promotion-contract.md`
...
- **Source anchors**:
  ...
  - approval-state projections documented in `docs/integration/governance-adapter.md`
  - approval semantics referenced by `docs/integration/project-memory-promotion-contract.md`
- **Required metadata fields**:
...
- **Source anchors**:
  ...
  - readiness projections documented in `docs/integration/governance-adapter.md`
  - packet routing semantics in `docs/integration/project-memory-promotion-contract.md`
- **Required metadata fields**:
  - `delight_provider_contract_version`
  - `contract_line`
  - `schema_version`
...
- **Source anchors**:
  ...
  - promoted `docs/security-assessments` surfaces routed by `crates/canon-engine/src/orchestrator/publish.rs`
  - packet lineage and promotion semantics from `docs/integration/project-memory-promotion-contract.md`
- **Required metadata fields**:
  - `delight_provider_contract_version`
  - `contract_line`
  - `schema_version`
...
- **Source anchors**:
  ...
  - promotion targets and routing semantics in `docs/integration/project-memory-promotion-contract.md`
- **Required metadata fields**:
  - `delight_provider_contract_version`
  - `contract_line`
  - `schema_version`
