...
1. Review `tech-docs/integration/governed-expertise-input-contract.md` and confirm it names the supported expertise kinds, classification rules, and ownership boundary.
2. Review `tech-docs/integration/project-memory-promotion-contract.md` and confirm the expertise-input contract extends existing publication semantics instead of replacing them.
