...
2. Review `docs/integration/governance-adapter.md` and the delivered personas or authority-zones guide to confirm the machine-facing and human-facing docs describe the same contract line.
