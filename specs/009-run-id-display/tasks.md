...
- [x] T041 Update `defaults/embedded-skills/canon-shared/references/runtime-compatibility.toml` and `.agents/skills/canon-shared/references/runtime-compatibility.toml` to bump compatible runtime version (e.g. 0.8.x → 0.14.0) reflecting the new manifest schema and resolver surface.
