...
**Storage**: local filesystem under `.canon/`, published repository docs under `tech-docs/` and `specs/`, and repo-local feature artifacts under `specs/042-visual-artifact-generation/`.  
