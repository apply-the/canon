...
2. Review `specs/055-adaptive-governance/contracts/adaptive-governance-adapter-projection.md` and `docs/integration/governance-adapter.md` to confirm the machine-facing projection preserves the same boundary.
