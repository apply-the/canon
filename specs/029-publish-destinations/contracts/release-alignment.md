...
| `README.md`, `ROADMAP.md`, and `tech-docs/guides/modes.md` | publish behavior is described accurately for the shipped slice | focused release-surface doc review passes |
