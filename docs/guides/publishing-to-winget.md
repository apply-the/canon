...
- You already have a release version such as `0.25.0`.
- The GitHub release tag will be `v0.25.0`.
...
The scripts in this repository expect the raw semantic version like `0.25.0`,
...
- Passing `v0.25.0` to the scripts instead of `0.25.0`
