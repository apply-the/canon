...
- `stable_doc`: `docs/integration/governed-expertise-input-contract.md`
...
- Publication, target-class, artifact-class, and metadata-carrier semantics
  remain governed by `docs/integration/project-memory-promotion-contract.md`.
...
- Target classes such as `stable`, `pending`, `proposal`, `evidence`, and
  `index` remain defined by `docs/integration/project-memory-promotion-contract.md`.
