...
4. Follow this execution flow:
    ...
    5. Fill Governance Context section
       If mode, risk, scope, or invariants cannot be derived: ERROR "Cannot establish governance context"
    ...
    9. Create Validation Plan
       Define structural, logical, and independent validation plus evidence artifacts
    10. Seed Decision Log
       Record at least one initial decision or open question with rationale
...
- **Mandatory sections**: Governance Context, User Scenarios & Testing,
  Requirements, Success Criteria, Validation Plan, Decision Log, Non-Goals,
  Assumptions
