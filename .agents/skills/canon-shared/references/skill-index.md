...
| `canon-requirements` | executable-wrapper | `available-now` | prominent | `canon-status`, `canon-inspect-evidence` |
...
| `canon-discovery` | support-state-wrapper | `modeled-only` | discoverable-standard | `canon-requirements`, `canon-architecture` |
| `canon-greenfield` | support-state-wrapper | `modeled-only` | discoverable-standard | `canon-requirements`, `canon-implementation` |
| `canon-architecture` | support-state-wrapper | `modeled-only` | discoverable-standard | `canon-requirements`, `canon-brownfield` |
