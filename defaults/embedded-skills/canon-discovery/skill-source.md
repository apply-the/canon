...
- Discovery is one of Canon's five targeted planning modes with first-class same-run refinement.
- During draft clarification, Canon may materialize `.canon/runs/<RUN_ID>/artifacts/discovery/working-brief.md` while keeping `canon-input/` read-only.
