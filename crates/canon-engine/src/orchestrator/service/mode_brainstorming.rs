...
impl EngineService {
    pub(super) fn run_brainstorming(
        ...
        let context_request = self.governed_request(GovernedRequestSpec {
            ...
            summary: "capture brainstorming context and problem space",
        ...
        let context_attempt = self.completed_attempt(
            ...
            ToolOutcome {
                ...
                summary: format!(
                    "Captured brainstorming context from {} input(s).",
        ...
        let generation_request = self.governed_request(GovernedRequestSpec {
            ...
            summary: "generate bounded brainstorming analysis",
            scope: input_scope.clone(),
        });
        ...
        let critique_request = self.governed_request(GovernedRequestSpec {
            ...
            summary: "critique bounded brainstorming analysis",
            scope: input_scope.clone(),
        });
        ...
        let artifacts = artifact_contract
            ...
            .map(|requirement| PersistedArtifact {
                ...
                contents: match artifact_slug(&requirement.file_name) {
                    ...
                    _ => crate::artifacts::markdown::render_brainstorming_artifact(
                        &requirement.file_name,
                        &context_summary,
        ...
        let gate_inputs = artifacts
            ...
            .collect::<Vec<_>>();
        let gates = gatekeeper::evaluate_brainstorming_gates(
            &artifact_contract,
            &gate_inputs,
