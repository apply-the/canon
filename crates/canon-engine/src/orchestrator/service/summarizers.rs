...
pub(crate) fn summarize_mode_result(
    ...
    match mode {
        ...
        Mode::DomainLanguage => summarize_domain_language_mode_result(artifacts),
        Mode::DomainModel => summarize_domain_model_mode_result(artifacts),
    }
}
...
fn summarize_domain_language_mode_result(
    artifacts: &[PersistedArtifact],
) -> Option<ModeResultSummary> {
    let primary =
...
fn summarize_domain_model_mode_result(
    artifacts: &[PersistedArtifact],
) -> Option<ModeResultSummary> {
    let primary =
