...
impl EngineService {
    pub(super) fn run_security_assessment(
        &self,
        ...
        let context_request = self.governed_request(GovernedRequestSpec {
            ...
            summary: "capture security assessment context and bounded threat surface",
        ...
        let context_attempt = self.completed_attempt(
            ...
            ToolOutcome {
                ...
                summary: format!(
                    "Captured security-assessment context from {} authored input(s).",
        ...
        let generation_request = self.governed_request(GovernedRequestSpec {
            ...
            summary: "generate bounded security assessment packet",
            scope: input_scope.clone(),
        });
        ...
        let critique_request = self.governed_request(GovernedRequestSpec {
            ...
            summary: "critique security findings, evidence gaps, and mitigation credibility",
            scope: input_scope.clone(),
        });
        ...
        let validation_request = self.governed_request(GovernedRequestSpec {
            ...
            summary: "validate security assessment packet against repository surface",
            scope: input_scope.clone(),
        });
        ...
        let artifacts = artifact_contract
            ...
            .map(|requirement| PersistedArtifact {
                ...
                contents: render_security_assessment_artifact(
                    &requirement.file_name,
                    &context_summary,
                ),
            })
        ...
        let gate_inputs = artifacts
            ...
            .collect::<Vec<_>>();
        let gates = gatekeeper::evaluate_security_assessment_gates(
            &artifact_contract,
            &gate_inputs,
